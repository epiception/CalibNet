...
def load(p_no, mode):
    ...
    for s_name, t_name, img_source_name, img_target_name, transform in tqdm(zip(source_file_names, target_file_names, source_image_names, target_image_names, transforms)):
        ...
        warped_ip = smc.imresize(warped_ip, (IMG_HT, IMG_WDT))
        ...
        target_ip = smc.imresize(target_ip, (IMG_HT, IMG_WDT))
        ...
        source_img = smc.imresize(source_img, (IMG_HT, IMG_WDT))
        ...
        target_img = smc.imresize(target_img, (IMG_HT, IMG_WDT))
