...
def End_Net_weights_init():
    ...
    W_fc_rot = weight_variable_fc([960,3], "_12")

    W_ext4_tr = weight_variable([1,1,96,96], "_13")
    W_fc_tr = weight_variable_fc([960,3], "_14")
...
def End_Net(input_x, phase_depth, keep_prob):
    ...
    layer11_m_rot = tf.reshape(layer11_rot, [batch_size, 960])
    ...
    layer11_m_tr = tf.reshape(layer11_tr, [batch_size, 960])
